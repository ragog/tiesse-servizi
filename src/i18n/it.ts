export default {
  ...
  missione: {
    ...
    description: "Affiancare il partner trasformando la complessità del processo edilizio in un ercorso fluido, governabile e conforme agli obiettivi tecnici ed economici. Il nostro lavoro riduce rischi operativi e finanzari, semplifia le interazioni tra i soggetti e tutela l'investimento.",
    points: [
      "",
      "",
      ""
